...
const (
	// msgNoRepo is returned when the workspace is not a git repository.
	msgNoRepo = "No git diff available."
	// msgNoChanges is returned when nothing matches the requested scope.
	msgNoChanges = "No matching changes."
)
